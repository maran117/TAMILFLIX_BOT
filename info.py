...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7320791501:AAGT1R762xjDhrkDaofkSOibpqe_iGGYTAI') #bot token from botfather
if len(BOT_TOKEN) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002401488764 -1002415184072 -1002457425264').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1001692297236').split()]
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://maran8098:NvSorzJUR30cfBis@cluster0.npnq3.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") #mongo db url
...
FILE_CAPTION = environ.get("FILE_CAPTION", '@TamilFlix_Mv {file_name')
...
STICKERS_IDS = (
    "CAACAgQAAxkBAAENAlpnGmmp-ZH4q3DfXDnKah6KYH991QACbgADjRtGJwXgb_wN4Ty3NgQ CAACAgQAAxkBAAENAlxnGmmuyEEJU89n5f_iIJ3uMP8YTwACZQADjRtGJ7QMriMrcV1oNgQ"
).split()
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/678df66faaded07e71f3c-2e58a1a2a4433a9ae6.jpg') #telegraph link of your QR code 
...
URL = environ.get("URL", "https://promising-melinda-tamilflix-79c023b0.koyeb.app/") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
