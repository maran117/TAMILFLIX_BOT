...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002480279086').split()]
...
STICKERS_IDS = (
    "CAACAgQAAxkBAAENAl5nGmm-VGH-XarK8adAMzxGmlvyLgAClwADjRtGJ1KamR3yTWSzNgQ"
).split()
