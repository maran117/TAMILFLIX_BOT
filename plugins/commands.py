...
async def start(client, message):
    ...
    if not await db.has_premium_access(message.from_user.id):
        if IS_VERIFY and not verify_status['is_verified']:
            ...
            await message.reply("✨YOU ARE NOT VERIFIED !\nKINDLY VERIFY TO CONTINUE & YOU CAN GET UNLIMITED ACCESS FOR 24 HOURS ✅\n\n⚜️ இந்த BOT இலிருந்து MOVIE பெற, நீங்கள் VERIFY செய்த பிறகு, 24 மணிநேரத்திற்கு UNLIMITED திரைப்படங்களைப் பெறலாம். \n\n🎯  நீங்கள் சரிபார்க்க விரும்பவில்லை என்றால், நீங்கள் PREMIUM எடுக்கலாம், PREMIUM எடுத்த பிறகு, நீங்கள் UNLIMITED MOVIES  பெற முடியும் மேலும் நீங்கள் சரிபார்க்க வேண்டியதில்லை\n\n💶 ꜱᴇɴᴅ /plans ᴛᴏ ʙᴜʏ ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ.", reply_markup=InlineKeyboardMarkup(btn), protect_content=True)
            return
    else:
        pass
...
async def plans_cmd_handler(client, message):                
    btn = [            
        [InlineKeyboardButton("ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ʀᴇᴄᴇɪᴘᴛ 🧾", url="https://t.me/TamilFlix_Admine_bot")],
